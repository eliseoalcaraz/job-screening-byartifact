...
export function Dropdown({ title, data }: DropdownProps) {
  return (
    <div className="group relative h-full flex items-center">
      <button
        className="flex items-center gap-1 focus:outline-none group-hover:text-blue-400 transition-colors duration-300"
        aria-haspopup="true"
      >
        {title}
        <ChevronDown
